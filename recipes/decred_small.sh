...
#SBATCH --output=outputs/decred_small.out
#SBATCH --error=outputs/decred_small.err
...
args=(
  ...
  --base_encoder_model="BUT-FIT/ebranchformer_12l_256h_80x256x2d"
  --base_decoder_model="BUT-FIT/gpt2_256h_6l"
  --ctc_weight="0.3"
  --decoder_pos_emb_fixed
  --config_overrides="decoder_head_locations=[4];decoder_head_weights=[0.3,0.7]"
